...
starship_api = Blueprint("starships", __name__, url_prefix="/api/starships")


@starship_api.route("/get_starships", methods=["GET"])
def get_starships():
...
@starship_api.route("/post_starship", methods=["POST"])
